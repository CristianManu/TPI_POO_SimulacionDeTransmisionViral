...
public class Persona {
    ...
    /**
     * Funcion que asigna un estado aleatorio a una Persona cuando esta se
     * contagia.
     */
    public void setEstado() {
        ...
        switch (ran) {
            case 0:
                this.estado = Estado.Asintomatico;
                break;
            case 1:
                this.estado = Estado.Leve;
                break;
            case 2:
                this.estado = Estado.Moderado;
                break;
            case 3:
                this.estado = Estado.Grave;
                break;
        }
    }
    ...
    /**
     * Se le pasa la lista de personas, y contagia a aquellas que se encuentran
     * a cierta distancia, dependiendo del cuidado que tengan las dos personas.
     *
    ...
    public void contagiar(List<Persona> p) {
        for (int i = 0; i < p.size(); i++) {
            ...
            if (cerca(p.get(i)) && !p.get(i).isInmune() && p.get(i).isSano() && 
                    !p.get(i).isEnCasa() && !this.isCuarentena() && !this.isEnCasa()) {
    ...
    /**
     * Compara las distancias entre la persona acutal y la pasada por parametro
     * y devuelve true o false dependiendo si esta cerca o no.
     *
    ...
    /**
     * Funcion que añade una comorbilidad a la lista de comorbilidades de la
     * persona
     *
     * @param com
     */
    ...
    *Metodo para constructor, asigna un cuidado aleatorio
    ...
    /**
     * FUNCIONES DE LA INTERFAZ Estas funciones seran utilizadas exclusivamente
     * para la interaccion de los objetos con la interfaz Tambien contiene
     * atributos estaticos que interactuaran con la misma
     */
    ...
    public void update() {
        ...
        if (!this.isSano()) {
            //Cuando llega a cierto numero, se recupera. Sino sigue contando
